...
ARCH            ?= arm64
CROSS_COMPILE ?= /home/dave/a11toolchain/aarch64-linux-android-4.9/bin/aarch64-linux-androidkernel-
...
CC =/home/dave/ZenMaxBuilder/toolchains/proton-clang/bin/clang
CPP		= $(CC) -E
AR		= $(CROSS_COMPILE)ar
NM		= $(CROSS_COMPILE)nm
...
ifeq ($(cc-name),clang)
ifneq ($(CROSS_COMPILE),)
CLANG_TRIPLE	?= /home/dave/ZenMaxBuilder/toolchains/proton-clang/bin/aarch64-linux-gnu-
